...
export default function AzureFunctionsPage() {
  ...
  return (
    <main className="content">
      ...
      <div>
        <Breadcrumb items={breadcrumbItems} current={'Azure Functions'} />
      </div>
      <div className="sub-title w-[350px] ">Crear una azure función:</div>
      ...
      <div className="w-full md:w-1/1 lg:w-1/1">
          ...
          <div className="relative z-10 grid">
            ...
            <label><input  id="imagenContenedor" value="imagenContenedor" type="radio" name="tipoRecurso" checked={formData.tipoRecurso === 'imagenContenedor'} onChange={handleRadioChange} /> Imagen de Contenedor</label>
          </div>
      </div>
